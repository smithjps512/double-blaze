        ...
        <div className="container-page py-8">
          ...
          <p className="mt-4 flex flex-wrap gap-x-4 gap-y-1 text-sm text-blaze-maroon">
            {[
              ...
              ["/lessons/index.html", "Lessons, day by day"],
